...
public extension UIControl {
    ...
    func addControlEvent(_ controlEvents: UIControlEvents, closure: () -> ()) {
        self.addControlEvent(controlEvents, actionKitClosure: .noParameters(closure))
    }
    
    private func addControlEvent(_ controlEvents: UIControlEvents, actionKitClosure: ActionKitClosure) {
